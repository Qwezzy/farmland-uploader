...
<div id="wrapper" class="header">
  ...
  <div class="text-muted">Farmland uploader login form</div>
  <div class="jumbotron">
	  <legend class="">Login</legend>
			<form class="panel-heading" action="index.php" id="frmlogin" method="post" name="frmlogin" enctype="application/x-www-form-urlencoded">
				<label>Username</label>
				<input <?php if($login_error) echo 'class="error"'; ?> id="txtusername" name="txtusername" type="text" /><br><br>
				<label>Password</label>
				<input <?php if($login_error) echo 'class="error"'; ?> id="txtpassword" name="txtpassword" type="password" /><br><br>
				<button class="btn btn-success" type="submit" id="btnlogin">Try to login</button>
			</form>
		</div></div>
	<?php }else{ ?>
      ...
      <div class="jumbotron">
       ...
       <form action="test.php" method="post" accept-charset="utf-8" class="form-inline" enctype="multipart/form-data"><br/><br/>
	      <input name="envoyer" type="submit" formnovalidate class="btn btn-lg btn-success" formaction="teampostgres.php" value="Query" />   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
