...
<div class="jumbotron">
       ...
       <h3>Soumission d'un jeu de données:</h3>
       <p>Télécharger le <a href="maquette/Format traps Solsona formatted_checked.xlsx">fichier type</a>.</p>
       <p>Lire le <a href="maquette/Documentation.pdf" target="_blank">document</a> décrivant le format approprié des données.</p>
       <h5>&nbsp;</h5>

		<p>	<form action="test.php" method="post" accept-charset="utf-8" class="form-inline" enctype="multipart/form-data">	
		 	<input type="file" name="nom_fichier" class="container-fluid"/><br/><br/> 
		 	<input type="submit" name="envoyer" class="btn btn-lg btn-success" value="Envoyer le Fichier" formaction="test.php" /> </form></p>
      ...
      <div class="footer">
        <p>&copy; Farmland Biodiversity 2014 |   
       
    <b>&copy;Bienvenue:<?php echo $_SESSION['user']; ?></b>
